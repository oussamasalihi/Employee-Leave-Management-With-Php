...
try {
    ...
    $sql = "SELECT leave_id, tbl_leave_application.employee_id, tbl_employee.first_name, tbl_employee.last_name, leave_name, posting_date, leave_status FROM tbl_leave_application JOIN tbl_employee on tbl_leave_application.employee_id = tbl_employee.employee_id where leave_status=1";
