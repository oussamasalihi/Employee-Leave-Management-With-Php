...
if(isset($_POST['submit'])){
    // Retrieve department short name and name from form
    $designation_name = filter_data($_POST['designation_name']);
    $designation_description = filter_data($_POST['designation_description']);

    // Prepare INSERT statement
    $sql = "INSERT INTO tbl_designation (designation_name, designation_description) VALUES (:designation_name, :designation_description)";
    ...
    if($stmt->execute()){
        ...
        $msg = "Designation Added Successfuly";
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control"
                                                            placeholder="Input Designation" id="first-name-icon" name="designation_name" required>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control"
                                                            placeholder="Input Description" id="email-id-icon" name="designation_description" required>
                                                        <div class="form-control-icon">
                                                            <i class="fa fa-table"></i>
                                                        </div>
                                                    </div>
