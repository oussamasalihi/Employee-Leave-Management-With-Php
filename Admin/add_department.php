...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO tbl_department (department_short_name, department_name) VALUES (:department_short_name, :department_name)";
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control"
                                                            placeholder="Input Department" id="first-name-icon" name="department_short_name" required>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control"
                                                            placeholder="Input Department Name" id="email-id-icon" name="department_name" required>
                                                        <div class="form-control-icon">
                                                            <i class="fa fa-table"></i>
                                                        </div>
                                                    </div>
