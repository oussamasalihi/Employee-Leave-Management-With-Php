...
error_reporting(0);
    include("../config.php");
        ...
        if(isset($_POST["update"])){
            $employee_id_number = filter_data($_POST["employee_id_number"]);
            ...
            $sql = "UPDATE tbl_employee SET employee_id_number=:employee_id_number, gender=:gender, first_name=:first_name ,middle_name=:middle_name,last_name=:last_name,age=:age,email_address=:email_address,contact_number=:contact_number,department_short_name=:department_short_name,designation_name=:designation_name, username=:username, password=:password where employee_id =:employee_id";
            $stmt = $conn->prepare($sql);
            $stmt->bindParam("employee_id_number", $employee_id_number, PDO::PARAM_STR);
                                            ...
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="id number"
                                                        id="first-name-icon" value="<?php echo htmlentities($results->employee_id_number) ?>"  name="employee_id_number" >
                                            ...
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="username"
                                                        id="first-name-icon" value="<?php echo htmlentities($results->username)?>" name="username">
                                                    <div class="form-control-icon">
                                                        <i class="fa fa-user"></i>
                                                    </div>
                                                </div>
